...
def preprocess(text):
    ...
    new_words = ['also', 'based', 'new', 'great', 'similar', 'run', 'role', 'day', 'working', 'always',
                 ...
                 'similar', 'often', 'high', 'entire', 'main', 'preparing', 'etc', 'keep', 'time', 'small', 'take', 'regardless', 'able', 
                 'take', 'likely', 'responsible', 'importantly', 'advanced', 'run' , 'work', 'everything', 'list', 'find', 'assumes']
